    ...
    if (selectedProduct) {
      $.ajax({
        ...
        success: function(response) {
          console.log("rate", response.product_rate);  // Updated: 'response.rate' instead of 'response.product_rate'
          console.log("unit", response.unit);
          $('#rate-field').val(response.product_rate);  // Updated: 'response.rate' instead of 'response.product_rate'
...
$(document).ready(function() {
  $('#your-table-id').DataTable({
    "order": [[0, "asc"]] // Initialize the first column (Name) in ascending order
  });
});
(function() {
